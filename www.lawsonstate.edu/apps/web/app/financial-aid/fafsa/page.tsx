...
export default function FafsaPage() {
  return (
    <>
      ...
      >
        <HeroPhoto src="https://www.lawsonstate.edu/_resources/assets/img/News/financial-awareness-month-2-2026.webp" alt="Financial Aid Awareness Month at Lawson State" position="center 30%" />

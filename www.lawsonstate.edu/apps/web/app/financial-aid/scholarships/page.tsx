...
export default function ScholarshipsPage() {
  return (
    <>
      ...
      >
        <HeroPhoto src="https://www.lawsonstate.edu/_resources/assets/img/News/delta-sigma-theta-scholarship-1.webp" alt="Lawson State scholarship recipients" position="center 25%" />

...
export default function HighSchoolStudentsPage() {
  return (
    <>
      ...
      >
        <HeroPhoto src="https://www.lawsonstate.edu/_resources/assets/img/News/talk-of-alabama-1.JPEG" alt="High school students exploring Lawson State" position="center 30%" />

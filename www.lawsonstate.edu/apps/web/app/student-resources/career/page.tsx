...
export default function CareerServicesPage() {
  return (
    <>
      ...
      >
        <HeroPhoto src="https://www.lawsonstate.edu/_resources/assets/img/News/career-community-fair-2026.webp" alt="Career and Community Resource Fair at Lawson State" position="center 30%" />

...
const SERVICES = [
  ...
  },
  {
    ...
    href: '/library',
    external: false,
    how: 'Birmingham Campus · 205.929.2068',
  },
  {
...
export default function TutoringPage() {
  return (
    <>
      ...
      >
        <HeroPhoto src="https://www.lawsonstate.edu/_resources/assets/img/News/EMS-SimRig.webp" alt="Hands-on academic support at Lawson State" position="center 30%" />

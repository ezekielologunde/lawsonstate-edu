...
export default function TrioPage() {
  return (
    <>
      ...
      >
        <HeroPhoto src="https://www.lawsonstate.edu/_resources/assets/img/Calendar_Images/ignite-2.webp" alt="TRiO / IGNITE program participants at Lawson State" position="center 30%" />

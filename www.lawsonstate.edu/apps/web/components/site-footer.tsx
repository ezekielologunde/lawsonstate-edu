...
const footerLinks: Record<string, { label: string; href: string }[]> = {
  ...
  Admissions: [
    ...
    { label: 'Veterans Services', href: '/support/veterans' },
  ],
  'Student Services': [
    { label: 'Academic Support', href: '/support/academic' },
    { label: 'Career Services', href: '/support/career' },
    { label: 'Health & Wellness', href: '/support/health' },
    { label: 'TRiO Programs', href: '/support/trio' },
  ],
  Institution: [

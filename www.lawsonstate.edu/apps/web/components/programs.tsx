  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="flex items-end justify-between flex-wrap gap-6 mb-4">
            <div>
              <p style={{
                ...
                color: 'var(--lscc-eyebrow)', marginBottom: '0.5rem', fontWeight: 700,
              }}>
        ...
        {/* Graceful fallback — if featured programs are ever unavailable, the visitor
            still gets a confident, on-brand path forward instead of a dead "loading" state. */}
        {programs.length === 0 && (
          <div
            className="text-center"
            style={{
              padding: '3.5rem 1.5rem', background: 'white', borderRadius: '1.25rem',
              border: '1px solid oklch(0.88 0.02 263)',
              boxShadow: '0 6px 24px oklch(0.16 0.13 263 / 0.06)',
            }}
          >
            <p
              className="font-display font-black"
              style={{ fontSize: 'clamp(1.4rem, 2.5vw, 1.9rem)', letterSpacing: '-0.02em', color: 'oklch(0.16 0.04 261)', marginBottom: '0.5rem' }}
            >
              200+ programs across 6 academic divisions
            </p>
            <p style={{ color: 'oklch(0.40 0.04 261)', fontSize: '1rem', lineHeight: 1.7, maxWidth: '48ch', margin: '0 auto 1.75rem' }}>
              From health sciences and business to skilled trades and transfer degrees —

    ...
    <div className="relative flex-1 flex flex-col overflow-hidden">
      ...
      <div className="relative z-20 max-w-[1440px] mx-auto w-full px-5 sm:px-8 lg:px-12 pb-14 sm:pb-16 lg:pb-20">
        ...
        <div className="flex flex-col sm:flex-row items-start gap-4 sm:gap-5">
          ...
          <button className="group inline-flex items-center gap-2 bg-[#F26522] hover:bg-[#e05a1a] text-white rounded-full pl-5 sm:pl-6 pr-2 py-2 transition-colors duration-200">
            <div className="overflow-hidden h-[20px] flex items-center">
              <div
                ...
                style={{ fontSize: '13px' }}
              >
                <span className="leading-5 whitespace-nowrap sm:text-[14px]">Start a project</span>
                <span className="leading-5 whitespace-nowrap sm:text-[14px]">Start a project</span>
              </div>
            </div>
          ...
          {/* Partner badge */}
          <div
            className="inline-flex items-center gap-2 bg-white rounded-[4px] px-3 py-2 transition-shadow duration-200 cursor-default"

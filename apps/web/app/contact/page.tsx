...
export default function ContactPage() {
  return (
    <main>
      {/* Hero */}
      <section style={{ background: 'oklch(0.14 0.10 261)', paddingTop: '8rem', paddingBottom: '5rem' }}>
        <div className="max-w-7xl mx-auto px-6">
          ...
          >
            <Link href="/" className="hover:text-white transition-colors" style={{ color: 'oklch(1 0 0 / 0.45)' }}>Home</Link>
            <span>/</span>
            <span style={{ color: 'oklch(1 0 0 / 0.72)' }}>Contact</span>
          </nav>
          ...
          <h1
            className="page-fade-2 font-display font-black text-white leading-none mb-5"
          ...
          <p
            ...
            style={{ color: 'oklch(1 0 0 / 0.72)', lineHeight: 1.75 }}
          >
      ...
      <section style={{ background: 'oklch(0.18 0.14 261)', padding: '5rem 0' }}>
        <div className="max-w-7xl mx-auto px-6">
          <h2
            className="scroll-reveal font-display font-black text-white text-2xl mb-8"
          ...
          <div className="stagger-grid grid md:grid-cols-2 gap-6">
            {CAMPUSES.map((campus) => (
              ...
              >
                <h3 className="font-display font-bold text-white text-xl mb-4">{campus.name}</h3>
                <address className="not-italic mb-5" style={{ color: 'oklch(1 0 0 / 0.72)', lineHeight: 1.8 }}>
                  {campus.address}<br />{campus.city}
                  <br />
                  <span style={{ color: 'oklch(1 0 0 / 0.45)', fontSize: '0.875rem' }}>{campus.hours}</span>
                </address>
                <a
                  href={`tel:${campus.tel}`}
                  className="font-bold block mb-4 hover:opacity-75 transition-opacity"
                  style={{ color: 'oklch(0.79 0.19 78)', fontSize: '1.15rem' }}
                >
                  {campus.phone}
                </a>
                <a
      ...
      {/* Department contacts */}
      <section style={{ background: 'oklch(0.14 0.10 261)', padding: '5rem 0' }}>
        <div className="max-w-7xl mx-auto px-6">
          <h2
            className="scroll-reveal font-display font-black text-white text-2xl mb-8"
            style={{ letterSpacing: '-0.02em' }}
          ...
          <div className="stagger-grid grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {DEPARTMENTS.map((dept) => (
              <div
                ...
                style={{ background: 'oklch(0.20 0.15 261)', border: '1px solid oklch(1 0 0 / 0.10)' }}
              >
                <p
                ...
                <a
                  href={`tel:${dept.tel}`}
                  className="text-white font-semibold text-sm hover:opacity-75 transition-opacity"
                >
                  {dept.phone}
                </a>
              </div>
          ...
          <p className="mt-6 text-sm" style={{ color: 'oklch(1 0 0 / 0.40)' }}>
      ...
      {/* CTA strip */}
      <section style={{ background: 'oklch(0.22 0.16 261)', padding: '4rem 0', borderTop: '1px solid oklch(1 0 0 / 0.08)' }}>
        <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row md:items-center md:justify-between gap-6">
          <div>
            ...
            <p style={{ color: 'oklch(1 0 0 / 0.60)' }}>

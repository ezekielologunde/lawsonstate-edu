      ...
      >
        ...
        <div className="relative max-w-7xl mx-auto w-full">
          ...
          <div className="flex flex-wrap gap-3 mt-6">
            ...
            <Link href="/academics" className="press hero-cta-ghost font-semibold px-6 py-3 rounded-lg text-white inline-block" style={{ border: '1.5px solid oklch(1 0 0 / 0.25)', fontSize: '0.875rem' }}>
              Browse All Programs
            </Link>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-6 py-5 grid grid-cols-2 sm:grid-cols-4 gap-4">
          {OUTCOMES.map(o => (
            <div key={o.label} className="text-center">
              ...
              <div className="font-semibold uppercase mt-1" style={{ fontSize: '0.6rem', letterSpacing: '0.14em', color: 'oklch(0.11 0.03 261 / 0.6)' }}>{o.label}</div>
            </div>
          ))}
        </div>
      </div>
      ...
      <section className="py-20 px-6" style={{ background: 'white' }}>
        <div className="max-w-7xl mx-auto">
          <div className="mb-12 scroll-reveal">
            <p className="font-display font-semibold uppercase mb-3" style={{ color: 'oklch(0.79 0.19 78)', fontSize: '0.68rem', letterSpacing: '0.2em' }}>Training Programs</p>
            <h2 className="font-display font-black leading-none text-lscc-ink" style={{ fontSize: 'clamp(1.8rem, 4vw, 3rem)', letterSpacing: '-0.025em' }}>FAST-TRACK CREDENTIALS</h2>
          </div>
            ...
            {PROGRAMS.map(cat => (
              <div key={cat.category} className="scroll-reveal">
                <h3
                  ...
                  style={{ background: cat.color, fontSize: '0.85rem', letterSpacing: '0.06em', textTransform: 'uppercase' }}
                >
                  {cat.category}
                </h3>
                  ...
                  {cat.items.map(item => (
                    ...
                    >
                      <div className="flex items-start justify-between gap-4 mb-3">
                        <h4 className="font-display font-bold text-lscc-ink leading-snug" style={{ fontSize: '0.95rem' }}>{item.name}</h4>
                        <span
                      ...
                      <div className="flex items-center gap-2 mb-3">
                        <span style={{ color: 'oklch(0.79 0.19 78)', fontSize: '0.7rem' }}>⏱</span>
                        <span className="font-semibold text-lscc-muted" style={{ fontSize: '0.8rem' }}>{item.duration}</span>
                      </div>
                      <p className="text-lscc-muted leading-relaxed" style={{ fontSize: '0.82rem' }}>{item.detail}</p>
                    </div>
                  ))}
                </div>
              </div>
      ...
      <section className="py-20 px-6" style={{ background: 'oklch(0.14 0.06 263)' }}>
        <div className="max-w-7xl mx-auto scroll-reveal">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <p className="font-display font-semibold uppercase mb-3" style={{ color: 'oklch(0.79 0.19 78)', fontSize: '0.68rem', letterSpacing: '0.2em' }}>No-Cost Program</p>
              <h2 className="font-display font-black leading-none text-white mb-4" style={{ fontSize: 'clamp(1.8rem, 4vw, 2.8rem)', letterSpacing: '-0.025em' }}>
            ...
            <div className="stagger-grid grid grid-cols-1 sm:grid-cols-2 gap-4">
              {[
                ...
                <div key={item.label} className="rounded-xl p-5" style={{ background: 'oklch(0.19 0.08 263)', border: '1px solid oklch(1 0 0 / 0.07)' }}>
                  ...
                  <p className="text-white/70 leading-snug" style={{ fontSize: '0.85rem' }}>{item.label}</p>
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="order-2 lg:order-1">
              <div className="rounded-2xl p-8" style={{ background: 'oklch(0.22 0.17 261)' }}>
                ...
                <p className="text-white/60" style={{ fontSize: '0.9rem' }}>Apprenticeship Program Partners working with Lawson State students</p>
              </div>
            </div>
            <div className="order-1 lg:order-2">
              <p className="font-display font-semibold uppercase mb-3" style={{ color: 'oklch(0.79 0.19 78)', fontSize: '0.68rem', letterSpacing: '0.2em' }}>Earn While You Learn</p>
              <h2 className="font-display font-black leading-none text-lscc-ink mb-4" style={{ fontSize: 'clamp(1.8rem, 4vw, 2.8rem)', letterSpacing: '-0.025em' }}>
                APPRENTICESHIP PROGRAMS
              </h2>
              <p className="text-lscc-muted leading-relaxed mb-4" style={{ fontSize: '0.97rem' }}>
              ...
              <p className="text-lscc-muted leading-relaxed" style={{ fontSize: '0.97rem' }}>
        ...
        <div className="max-w-7xl mx-auto scroll-reveal">
          <div className="rounded-2xl p-8" style={{ background: 'white', border: '1px solid oklch(0.92 0.01 263)', boxShadow: '0 1px 3px oklch(0.11 0.03 261 / 0.06), 0 4px 18px oklch(0.11 0.03 261 / 0.1)' }}>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 text-sm">
              ...
              <div>
                <div className="font-semibold uppercase mb-1" style={{ fontSize: '0.6rem', letterSpacing: '0.14em', color: 'oklch(0.79 0.19 78)' }}>Location</div>
              ...
              <div>
                <div className="font-semibold uppercase mb-1" style={{ fontSize: '0.6rem', letterSpacing: '0.14em', color: 'oklch(0.79 0.19 78)' }}>Hours</div>
